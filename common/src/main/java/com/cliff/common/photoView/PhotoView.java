package com.cliff.common.photoView;
...
import com.cliff.common.utils.PhotoUtils;

public class PhotoView extends View {
    private static final float IMAGE_WIDTH = PhotoUtils.dpToPixel(300);
    ...
    private void init(Context context) {
        bitmap = PhotoUtils.getPhoto(getResources(), (int) IMAGE_WIDTH);
