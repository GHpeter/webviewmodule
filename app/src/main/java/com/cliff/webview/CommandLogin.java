...
import com.cliff.common.autoservice.IUserCenterService;
import com.cliff.common.eventbus.LoginEvent;
import com.cliff.webview.command.Command;
...
public class CommandLogin implements Command {
    IUserCenterService iUserCenterService = WebServiceLoader.load(IUserCenterService.class);
